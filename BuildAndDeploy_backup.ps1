# Build and Deploy Script for Annotatix
...
Write-Host "  Annotatix Build & Deploy" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$versionFolder = "annotatix_ver3.$($buildNumber.PadLeft(3, '0'))"
...
Write-Host "   1. Copy contents of 'annotatix_dependencies\' to:" -ForegroundColor Gray
Write-Host "      %APPDATA%\Autodesk\Revit\Addins\2024\annotatix_dependencies\" -ForegroundColor Gray
Write-Host "   2. Copy 'Annotatix.addin' to:" -ForegroundColor Gray
